...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\section{数学}
			...
			\subsection{多项式}
				...
				\subsubsection{拉格朗日插值}
					\input{../src-midori/math/拉格朗日插值.tex}
				\subsubsection{连通图计数}
					\input{../src-midori/math/连通图计数.tex}
			
			\subsection{线性代数}
				\subsubsection{高斯消元}
					\input{../src-midori/math/gauss.tex}
				\subsubsection{矩阵树定理}
					\input{../src-midori/math/矩阵树定理.tex}
				\subsubsection{线性基}
			...
			\subsection{反演与容斥}
				...
				\subsubsection{单位根反演}
					\input{../src-midori/math/单位根反演.tex}
				\subsubsection{Min-Max容斥}
					\input{../src-midori/math/Min-Max容斥.tex}
			
			\subsection{组合数}
				\subsubsection{常用组合数}
					\input{../src-midori/math/常用组合数.tex}
				\subsubsection{斯特林数}
					\input{../src-midori/math/斯特林数.tex}
				\subsubsection{欧拉数}
					\input{../src-midori/math/欧拉数.tex}

			\subsection{线性规划}
				\subsubsection{对偶原理}
					\input{../src-midori/math/线性规划对偶原理.tex}
			...
			\subsection{杂项}
				...
				\subsubsection{纳什均衡}
					\input{../src-midori/math/纳什均衡.tex}
				\subsubsection{康托展开}
					\input{../src-midori/math/康托展开.tex}
		...
		\section{数论}
			...
			\subsection{扩展欧拉定理}
				\input{../src-midori/number/扩展欧拉定理.tex}
		...
		\section{图论}
			...
			\subsection{Hall 定理}
				\input{../src-midori/graph/Hall定理.tex}
		...
		\section{字符串}
			...
			\subsection{广义后缀自动机}
				\subsubsection{对 Trie 建自动机}
					\input{../src-midori/string/广义后缀自动机-trie.tex}
		...
		%\section{杂项}
		%	\subsection{java 高精度}
		%		\inputminted{java}{../src-midori/other/高精度.tex}
		%	\subsection{重载 umap}
